...
public class NetApi {
    ...
    /**
      *  描述：?cardNo=yourcardNo&cardBinCheck=true   ======yourcardNo=========银行卡号     ，，，后面参数默认给true
      *  时间：2018/8/16 16:55
      **/
    public static String BankApi="https://ccdcapi.alipay.com/validateAndCacheCardInfo.json";//银行卡识别API
